...
def handle_mention(event_data):
    ...
    if "favorite color" in text.lower():
        colors = ["Blue",'Red',"Green","Brown","Fuchsia","Bleu cheese","Baby blue","Maroon","Lavender","Gray","Metal","Black. Oh yeah; that's not a color.","Beige","Tan", "Orange", "Yellow", "What is your favorte color, <@%s>?", "Amber", "I like all colors. In other words, I like white."] % user
